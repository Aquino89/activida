...
public class HUEMPLSWS {
	...
	// Listar
	// http://localhost:8001/api/HU_EMPLS/listar
	@GetMapping("/listar")
	...
	// Buscar por id
	// http://localhost:8001/api/HU_EMPLS/buscar/1
	...
	// crear
	// http://localhost:8001/api/HU_EMPLS/crear
	@PostMapping("/crear")
	...
	// Editar
	// http://localhost:8001/api/HU_EMPLS/editar
	...
	// Eliminar
	// http://localhost:8001/api/HU_EMPLS/eliminar
	...
	// http://localhost:8001/api/HU_EMPLS/buscar/1/1
	@GetMapping("/filter")
	...
	// http://localhost:8001/api/HU_EMPLS/buscar/1/USD
